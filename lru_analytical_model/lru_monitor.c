...
static void write_csv_header(FILE *fp)
{
    fprintf(
        ...
        "observed_shrink_input_anon_pages,observed_shrink_input_file_pages,"
        ...
        "observed_dirty_anon_pages,observed_dirty_file_pages,"
        "observed_writeback_anon_pages,observed_writeback_file_pages,"
        "observed_congested_anon_pages,observed_congested_file_pages,"
        "observed_immediate_anon_pages,observed_immediate_file_pages,"
        "observed_unmap_fail_anon_pages,observed_unmap_fail_file_pages,"
        "observed_putback_anon_pages,observed_putback_file_pages,"
...
static void write_csv_event(FILE *fp, const struct lru_event *event)
{
    fprintf(
        ...
        event->observed_shrink_input_anon_pages,
        event->observed_shrink_input_file_pages,
